...
export const Navigation = ({ routes, title, customLogo, themeButtonActive = true, pointColor = 'blue900', menuPosition = 'right', menuToggle, isMenuOpen = false, sideMenu, rightElement, }) => {
    const location = useLocation();
    return (_jsxs(NavWrapper, { children: [_jsxs(NavInner, { children: [_jsxs(NavTaskWrapper, { children: [(menuPosition == 'left' || menuPosition == 'left-mobile-only') && (_jsx(MenuButtonWrapper, { position: menuPosition, onClick: menuToggle, children: _jsx(MenuIcon, { isMenuOpen: isMenuOpen }) })), _jsx(StyledLogoWrapper, { to: '/', children: customLogo ? (_jsx(_Fragment, { children: customLogo })) : (_jsxs(_Fragment, { children: [_jsx(GDSCLogo, {}), _jsx(LogoTitle, { children: "GDSC" }), title ? (_jsxs(_Fragment, { children: [_jsx(NavSubtitle, { children: "DJU" }), _jsx(NavSubtitle, { color: pointColor, children: title })] })) : (_jsxs(_Fragment, { children: [_jsx(NavSubtitle, { color: pointColor, children: "Daejin" }), _jsx(NavSubtitle, { color: pointColor, children: "Univ." })] }))] })) }), routes && (_jsx(LinkWrapper, { children: routes.map((link) => (_jsx(StyledLi, { pointColor: pointColor, children: _jsx(StyledLink, { isRoute: location.pathname == link.route, to: link.route, pointColor: pointColor, children: link.title }) }, link.route))) }))] }), rightElement && _jsx(_Fragment, { children: rightElement }), themeButtonActive && _jsx(ThemeToggleButton, {}), (menuPosition === 'right' || menuPosition === 'right-mobile-only') && (_jsx(MenuButtonWrapper, { position: menuPosition, onClick: menuToggle, children: _jsx(MenuIcon, { isMenuOpen: isMenuOpen }) }))] }), _jsx(MobileMenu, { isMenuOpen: isMenuOpen, children: sideMenu })] }));
};
